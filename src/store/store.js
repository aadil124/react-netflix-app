...
export const fetchOriginals = createAsyncThunk("netflix/original", async () => {
  try {
    const {
      data: { results },
    } = await axios.get(`${TMDB_BASE_URL}${requests.fetchNetflixOriginals}`);
    return results;
  } catch (error) {
...
export const fetchTrendings = createAsyncThunk("netlfix/trending", async () => {
  try {
    const {
      data: { results },
    } = await axios.get(`${TMDB_BASE_URL}${requests.fetchTrending}`);
    return results;
  } catch (error) {
...
export const fetchTopRated = createAsyncThunk("netflix/topRated", async () => {
  try {
    const {
      data: { results },
    } = await axios.get(`${TMDB_BASE_URL}${requests.fetchTopRated}`);
    return results;
  } catch (error) {
...
export const fetchAction = createAsyncThunk("netflix/action", async () => {
  try {
    const {
      data: { results },
    } = await axios.get(`${TMDB_BASE_URL}${requests.fetchActionMovies}`);
    return results;
  } catch (error) {
...
export const fetchComedy = createAsyncThunk("netflix/comedy", async () => {
  try {
    const {
      data: { results },
    } = await axios.get(`${TMDB_BASE_URL}${requests.fetchComedyMovies}`);
    return results;
  } catch (error) {
    console.log(error, "error while calling fetchAction api");
  }
...
export const fetchHorror = createAsyncThunk("netflix/horror", async () => {
  try {
    const {
      data: { results },
    } = await axios.get(`${TMDB_BASE_URL}${requests.fetchHorrorMovies}`);
    return results;
  } catch (error) {
    console.log(error, "error while calling fetchAction api");
  }
...
export const fetchRomance = createAsyncThunk("netflix/romance", async () => {
  try {
    const {
      data: { results },
    } = await axios.get(`${TMDB_BASE_URL}${requests.fetchRomanceMovies}`);
    return results;
  } catch (error) {
    console.log(error, "error while calling fetchAction api");
  }
...
export const fetchDocumentaries = createAsyncThunk(
  ...
  async () => {
    try {
      const {
        data: { results },
      } = await axios.get(`${TMDB_BASE_URL}${requests.fetchDocumentaries}`);
      return results;
    } catch (error) {
      console.log(error, "error while calling fetchAction api");
    }
...
export const getUsersLikedMovies = createAsyncThunk(
  ...
  async (email) => {
    const {
      data: { movies },
    } = await axios.get(`${URL}/auth/getMovies/${email}`);
    return movies;
  }
);
...
export const fetchTVShows = createAsyncThunk("netflix/tv", async () => {
  try {
    const {
      data: { results },
    } = await axios.get(`${TMDB_BASE_URL}${requests.fetchTVShows}`);
    return results;
  } catch (error) {
...
export const deleteMovie = createAsyncThunk(
  ...
  async ({ email, movieId }) => {
    try {
      const {
        data: { movies },
      } = await axios.put(`${URL}/auth/delete`, { email, movieId });
      return movies;
    } catch (error) {
